...
/**
 * Service interface for querying team data from the Velocity proxy.
 *
 ...
 *
 * <p>Obtain an instance from {@link VelocityTeamsAPI#getService()}.</p>
 */
public interface VelocityTeamsService {
     ...
     */
    CompletableFuture<Optional<VelocityTeam>> getPlayerTeam(UUID playerUUID);
     ...
     * @return a future resolving to an Optional containing the team, or empty
     */
    CompletableFuture<Optional<VelocityTeam>> getTeam(UUID teamId);
     ...
     * @return a future resolving to an Optional containing the team, or empty
     */
    CompletableFuture<Optional<VelocityTeam>> getTeamByName(String name);
     ...
     */
    CompletableFuture<Optional<VelocityTeamRole>> getMemberRole(UUID teamId, UUID playerUUID);
     ...
     */
    CompletableFuture<Optional<VelocityTeamMember>> getMemberInfo(UUID teamId, UUID playerUUID);
     ...
     */
    CompletableFuture<Collection<VelocityTeam>> getAllTeams();
}
