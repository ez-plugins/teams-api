...
|----------|------|----------|-------|
| BetterTeams | TeamsAPI extension | Extension: [GitHub Releases](https://github.com/ez-plugins/teams-api/releases) / Plugin: [SpigotMC](https://www.spigotmc.org/resources/betterteams.17664/) | `2.2.0` | Official TeamsAPI extension module |
| Towny | TeamsAPI extension | Extension: [GitHub Releases](https://github.com/ez-plugins/teams-api/releases) / Plugin: [Modrinth](https://modrinth.com/plugin/towny) | `2.2.0` | Official TeamsAPI extension module |
| KingdomsX | TeamsAPI extension | Extension: [GitHub Releases](https://github.com/ez-plugins/teams-api/releases) / Plugin: [SpigotMC](https://www.spigotmc.org/resources/kingdomsx.77782/) | `2.2.0` | Official TeamsAPI extension module |
...
| Provider | Core `TeamsService` | Invite | Warp | Claim | Power | Relation | Notification |
|----------|----------------------|--------|------|-------|-------|----------|--------------|
| BetterTeams extension | Y (`2.2.0`) | P (`2.2.0+`) | Y (`2.2.0+`) | N | N | Y (`2.2.0+`) | N |
| Towny extension | Y (`2.2.0`) | N | N | P (`2.2.0+`) | N | Y (`2.2.0+`) | N |
| KingdomsX extension | Y (`2.2.0`) | N | N | P (`2.2.0+`) | P (`2.2.0+`) | Y (`2.2.0+`) | N |
| PVP-Index Factions | Y (`1.0.4`) | P (`1.0.4+`) | P (`1.0.4+`) | P (`1.0.4+`) | P (`1.0.4+`) | P (`1.0.4+`) | P (`1.0.4+`) |
...
- BetterTeams warp support covers full CRUD (`setWarp`, `removeWarp`, `getWarp`, `getWarps`) from `2.2.0+`.
