...
final class BungeeTeamData implements BungeeTeam {
    ...
    private final Collection<BungeeTeamMember> members;
     ...
     */
    BungeeTeamData(final UUID id, final String name, final String displayName,
            final UUID ownerUUID, final int size, final int maxSize,
            final Collection<BungeeTeamMember> members) {
        this.id = id;
        this.name = name;
     ...
     */
    @Override
    public Collection<BungeeTeamMember> getMembers() {
        return members;
    }
     ...
     */
    @Override
    public Optional<BungeeTeamMember> getMember(final UUID playerUUID) {
